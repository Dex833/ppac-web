            ...
            <div className="space-y-2">
              ...
              <div className="flex items-start gap-2">
                {qr?.static?.gcash?.imageUrl && (
                  <img src={qr.static.gcash.imageUrl} alt="GCash QR" className="max-w-[240px] h-auto rounded border" />
                )}
                {qr?.static?.bank?.imageUrl && (
                  <img src={qr.static.bank.imageUrl} alt="Bank QR" className="max-w-[240px] h-auto rounded border" />
                )}
              </div>
